...
const ActorsPage = () => {
    ...
    // Fetch actors based on applied filters
    useEffect(() => {
        const fetchActors = async () => {
            try {
                ...
                console.log('Fetching actors from:', apiUrl);
                ...
                const result = await response.json();
                console.log('Actors List API Response:', result);
    ...
    return (
        <>
            ...
            {/* Filters and Actors - Constrained Width */}
            <div className="actors-page">
                {/* Filter Section */}
                ...
                {filteredUsers.length === 0 ? (
                    <div className="empty-container">
                        <p className="empty-message">
                            {selectedCountry || selectedState || selectedCity
                                ? 'No actors found matching the selected filters'
                                : 'No actors found'}
                        </p>
                    </div>
                ) : (
                                ...
                                >
                                    <div className="actor-image-wrapper">
                                        <img
                                            ...
                                            onError={(e) => {
                                                console.error('Failed to load actor image:', userImgSrc);
